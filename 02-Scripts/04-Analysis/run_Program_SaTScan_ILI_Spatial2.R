...
param <- read_file("./01-Data/02-Analytic-Data/SaTScan/input2/parameters_original.prm")
# save separate from original in case errors
# restore original settings
write_file(param, file = "./01-Data/02-Analytic-Data/SaTScan/input2/parameters.prm")
...
for(i in 1:length(unique(ili2$week_start))){
  ...
  param <- read_file("./01-Data/02-Analytic-Data/SaTScan/input2/parameters.prm")
  ...
  readr::write_file(param, file = "./01-Data/02-Analytic-Data/SaTScan/input2/parameters.prm")
  ...
  system('"C:/Program Files/SaTScan/SaTScanBatch64.exe" "G:/Research/ILI-Clustering/01-Data/02-Analytic-Data/SaTScan/input2/parameters.prm"')
