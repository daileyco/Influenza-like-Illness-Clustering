...
load("./01-Data/01-Processed-Data/satscan_clusters_ili_spatial.rds")
...
is.clusters.network <- clusters.network

save(is.clusters.network, file = "./01-Data/02-Analytic-Data/satscan_clusters_ili_spatial_network.rds")
