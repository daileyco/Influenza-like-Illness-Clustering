...
satscan.files <- list.files("./01-Data/02-Analytic-Data/SaTScan/output3", full=T, pattern = "eiunit_ili")
...
save(all.clusters.df, file = "./01-Data/01-Processed-Data/satscan_clusters_ili_acs.rds")
